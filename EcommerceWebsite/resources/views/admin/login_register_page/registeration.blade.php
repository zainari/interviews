...
<head>
    ...
    <title>Create Account | Wasaaz</title>
...
<body>
    <div class="auth-card">
        ...
        <p class="subtitle">Join Wasaaz for an elevated shopping experience</p>
        ...
        <div class="social-login">
            <button type="button" class="social-btn" aria-label="Register with Google">
                <i class="fab fa-google"></i>
            </button>
            <button type="button" class="social-btn" aria-label="Register with Apple">
                <i class="fab fa-apple"></i>
            </button>
            <button type="button" class="social-btn" aria-label="Register with Facebook">
                <i class="fab fa-facebook-f"></i>
            </button>
        </div>

        <p class="footer-text">
            Already have an account? <a href="{{ route('user.loginpage') }}">Sign in</a>
        </p>
    </div>
</body>
</html>
